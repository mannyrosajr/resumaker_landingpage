...
const sections = [
    ...
    body: [
      { type: 'p', text: 'We collect only what is needed to generate your resume and manage your subscription:' },
      {
        ...
        items: [
          ...
          "Billing information — if you subscribe to Plus or Pro, our payment processor (Stripe) collects your payment details, billing email, and country directly; we never receive or store your card number. We store your subscription tier, status, and renewal date to enforce your plan's usage limits.",
        ],
      },
      {
        type: 'p',
    ...
    body: [
      {
        ...
        items: [
          ...
          'To process subscription payments, enforce plan limits, and manage billing (upgrades, cancellations, renewals) via Stripe.',
        ],
      },
      {
        type: 'p',
    ...
    body: [
      { type: 'p', text: 'Resumaker relies on the following services to operate:' },
      {
        ...
        items: [
          ...
          <>
            Stripe — our payment processor for Plus and Pro subscriptions. Stripe
            securely processes your card payment directly; we receive only your
            subscription status and renewal date, never your full card number.{' '}
  ...
  },
  {
    ...
    body: [
      {
        type: 'p',
        text: "Your data is stored in Google Firebase (Firestore), protected by Firebase's security rules so only you can access your own profile, resumes, and subscription status. Subscription and usage data can only be written by our backend, never directly by the extension, preventing tampering. Your Anthropic API key and Stripe API credentials are stored in Google Cloud Secret Manager and are never exposed to the extension or your browser.",
      },
    ],
  },
  {
        ...
        <section className="section split-section legal-section" aria-label="Privacy Policy sections">
          ...
          <div className="legal-doc">
            ...
            <p className="legal-disclaimer">
              ...
              LinkedIn, Anthropic, Stripe, or any job board mentioned in the
              extension.
            </p>
          </div>
        </section>
